          ...
          <div className="text-center mb-12">
            ...
            <div className="max-w-md mx-auto mt-5 mb-8">
              <p className="text-gray-800 text-base md:text-lg">
                These premium mango varieties have proven to be a hit! Explore our most loved selections from Indian farms, each with its unique flavor and story.
              </p>
            </div>
            ...
            <div className="mt-8 md:mt-12">
              <Link to="/mangoes">
                <Button variant="primary" className="bg-red-700 hover:bg-red-800 text-white uppercase font-bold px-6 py-3">
      ...
      <div className="container mx-auto mt-12 md:mt-14 relative" style={{ zIndex: 1 }}>
        <div className="px-0 overflow-hidden">
          <Swiper
            ...
            className="py-6 fan-favorites-carousel"
          >
            {featuredMangoes.map((mango) => (
              <SwiperSlide key={mango.id}>
